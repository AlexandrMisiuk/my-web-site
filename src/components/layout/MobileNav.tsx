...
export function MobileNav({ isOpen, onClose, activeId, triggerRef, items = defaultNavItems }: MobileNavProps) {
    ...
    return (
        <div
            ...
            className="bg-canvas fixed inset-x-0 top-(--header-height) z-40 flex h-(--mobile-nav-height) flex-col overflow-y-auto p-6 md:hidden"
        >
